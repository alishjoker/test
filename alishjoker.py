...
wait = {
    ...
    'autoAdd':True,
    'message':"سلام 
به ربات کنسل خوش اومدی
اموزش استفاده از ربات 
1-ربات دعوت گروه کنید
2- دستور کنسل را ارسال کنید 
3-بعد از انجام هر کاری ربات را پاک کنید تا سرعت ربات کم نشود...
صفحه ما در لاین حتما ادد کنید منو
https://line.me/R/ti/p/%40hkl8562e",
    "lang":"JP",
    "comment":"سلام 
به ربات کنسل خوش اومدی
اموزش استفاده از ربات 
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                if msg.toType == 2:
                    ...
                    ki.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done alish Joker")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done alish Joker")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done alish Joker")
                    else:
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Selamat datang di Alish Joker Family Room")
